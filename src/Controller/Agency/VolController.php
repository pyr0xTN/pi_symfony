...
class VolController extends AbstractController
{
    public function __construct(
        ...
        #[Autowire('%aviationstack_api_key%')]
        private string $aviationstackApiKey,
    ) {}

    #[Route('', name: 'agency_vol_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'agency_vol_new', methods: ['GET', 'POST'])]
    public function new(Request $request): Response
    {
        ...
        return $this->render('agency/vol/new.html.twig', [
            'active_page' => 'services',
            'form'        => $form,
        ]);
    }

    #[Route('/autofill', name: 'agency_vol_autofill', methods: ['GET'])]
    ...
    #[Route('/{id}', name: 'agency_vol_show', methods: ['GET'])]
    public function show(int $id): Response
    {
        $vol = $this->findVolOrFail($id);

        return $this->render('agency/vol/show.html.twig', [
            'active_page' => 'services',
            'vol'         => $vol,
        ]);
    }

    #[Route('/details/{id}', name: 'agency_vol_showdetails', methods: ['GET'])]
    public function details(int $id): Response
    {
        $vol = $this->findVolOrFail($id);

        return $this->render('agency/vol/showdetails.html.twig', [
            'active_page' => 'services',
            'vol'         => $vol,
        ]);
    }

    #[Route('/{id}/edit', name: 'agency_vol_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, int $id): Response
    {
        ...
        return $this->render('agency/vol/edit.html.twig', [
            'active_page' => 'services',
            'form'        => $form,
            'vol'         => $vol,
        ]);
    ...
    #[Route('/{id}/delete', name: 'agency_vol_delete', methods: ['GET', 'POST'])]
