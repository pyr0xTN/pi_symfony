...
class HotelController extends AbstractController
{
    public function __construct(
        ...
        #[Autowire('%makcorps_api_key%')]
        private string $makcorpsApiKey,
    ) {}

    #[Route('', name: 'agency_hotel_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'agency_hotel_new', methods: ['GET', 'POST'])]
    public function new(Request $request): Response
    {
        ...
        return $this->render('agency/hotel/new.html.twig', [
            'active_page' => 'services',
            'form'        => $form,
        ]);
    }

    #[Route('/autofill', name: 'agency_hotel_autofill', methods: ['GET'])]
    ...
    #[Route('/{id}', name: 'agency_hotel_show', methods: ['GET'])]
    public function show(int $id): Response
    {
        $hotel = $this->findHotelOrFail($id);

        return $this->render('agency/hotel/show.html.twig', [
            'active_page' => 'services',
            'hotel'       => $hotel,
        ]);
    }
    
    #[Route('/details/{id}', name: 'agency_hotel_showdetails', methods: ['GET'])]
    public function showdetails(int $id): Response
    {
        $hotel = $this->findHotelOrFail($id);

        return $this->render('agency/hotel/showdetails.html.twig', [
            'active_page' => 'services',
            'hotel'       => $hotel,
        ]);
    }

    #[Route('/{id}/edit', name: 'agency_hotel_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, int $id): Response
    {
        ...
        return $this->render('agency/hotel/edit.html.twig', [
            'active_page' => 'services',
            'form'        => $form,
            'hotel'       => $hotel,
        ]);
    ...
    #[Route('/{id}/delete', name: 'agency_hotel_delete', methods: ['GET', 'POST'])]
